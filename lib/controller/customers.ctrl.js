        ...
        if (req.decoded.success == true) {   
            connection.acquire(function(err, con){
                ...
                else
                {
                    ...
                    var sql2 = 'INSERT INTO `users`(`name`, `email`, `mobile`, `role`, `customerid`, `password`, `createdby`, `companyid`) VALUES (?,?,?,"customer",?,"'+password+'",'+req.decoded.logedinuser.id+','+req.decoded.logedinuser.companyid+')';
                    var type = 'newuser'
                }
